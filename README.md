![image](https://user-images.githubusercontent.com/107718650/236093233-647cfc28-b555-4131-b799-8a45a25cb9e1.png)

# GLASP FOR BEGINNERS
## A Beginners Handbook to Using GLASP
...
short for "Global Annotation Service for the Web," is a tool that allows users to highlight and annotate text on web pages.  Glasp was co-founded by Kazuki Nakayashiki. The web-based tool aims to create a platform where people can share information and learn from the experiences of others. The app was developed based on the idea that if everyone's brains were shared in a common repository like Dropbox, valuable information could be applied to activities that people believed in. Glasp is focused on leaving a legacy for future generations by making knowledge accessible and shareable.
...
![image](https://user-images.githubusercontent.com/107718650/236094449-967b888a-d0d5-4f37-9ad9-cb5520d3e821.png)


### Installation
Glasp, can be ins
talled as a browser extension in popular browsers like Google Chrome, Safari, and Mozilla Firefox. Once installed, users can activate it by clicking on the Glasp icon in the browser toolbar.

### Highlighting

Once activated, users can highlight text on web pages by selecting the text and clicking on the "highlight" button. Glasp will highlight the selected text in a 
...
Glasp can be used with screen, making it easier for people with disabilities to navigate the web. Screen readers can read out the highlights and annotations, allowing people with visual impairments to access the information.
...
After sign-in, you will be redirected to the Chrome web store

Then click on Add to Chrome to add the extension to your browser. 
...
Ensure to pin the tab to make it easier to locate and setup
. 
...
Create notes for the highlight with the Atomic Notes. 
...
Click on Setting to make sure Annotation is on. 




Click Transcript and Summary to view the caption or transcript for the video. 
Highlight the text you want, with your preferred color.
...
You can not highlight your local file because of technical issues. 
Features of Glasp 
Some of the best features of Glasp are it's 
...
Hypothes.is
It Hypothesis is a popular web annotation tool that allows users to highlight text, add comments, and collaborate with others. 

Pro 

Hypothesis is free to use and works on a wide range of websites. 
...
Glasp's collaborative features make it a great tool for teamwork and group projects, setting it apart from other highlighting tools that are primarily designed for individual use.
Glasp's powerful search and organization features make it easy to find and manage highlights, further differentiating it from other tools on the market.
Conclusion
